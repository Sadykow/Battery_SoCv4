...
for i in range(0, len(train_X)):
    tr_np_X[i,:,:] = scaler_SS.fit_transform(train_X[i][:7996])
    tr_np_Y[i,:,:] = scaler_MM.fit_transform(train_Y[i][:7996])
...
# %%
epochs : int = 100
file_path = 'Models/Stateful/LSTM_test2'
